...
class AnswerToolbar:
    ...
    def render(self):
        ...
        try:
            # Create frame
            self.toolbar_frame = tk.Frame(self.parent, bg=self.bg_color, height=28, relief=tk.FLAT, bd=0)
    ...
    def _create_separator(self):
        ...
        separator = tk.Label(self.toolbar_frame, text="|", bg=self.bg_color, fg="#E0E0E0", font=("Segoe UI", 10))
    ...
    def _show_metadata(self):
        ...
        try:
            ...
            # Text widget
            text = tk.Text(self.metadata_window, wrap=tk.WORD, font=("Consolas", 10), bg="#FAFAFA", fg="#212121")
    ...
    def _show_sources(self):
        ...
        try:
            ...
            text = tk.Text(self.sources_window, wrap=tk.WORD, font=("Segoe UI", 10), bg="#FAFAFA", fg="#212121")
            text.pack(fill=tk.BOTH, expand=True, padx=10, pady=10)
    ...
    def _show_suggestions(self):
        ...
        try:
            ...
            # Text widget
            text = tk.Text(self.suggestions_window, wrap=tk.WORD, font=("Segoe UI", 10), bg="#FAFAFA", fg="#212121")
            text.pack(fill=tk.BOTH, expand=True, padx=10, pady=10)
    ...
    def _show_raw(self):
        ...
        try:
            if self.on_show_raw:
                ...
                text = tk.Text(raw_window, wrap=tk.WORD, font=("Consolas", 10), bg="#263238", fg="#ECEFF1")
                text.pack(fill=tk.BOTH, expand=True, padx=10, pady=10)
