...
class TypingIndicator:
    ...
    def hide(self):
        ...
        if self.indicator_mark:
            try:
                ...
                start_index = self.text_widget.search("🤖 KI arbeitet", "1.0", tk.END)
                if start_index:
                    # Calculate end index
    ...
    def _insert_indicator(self):
        ...
        try:
            ...
            self.text_widget.tag_config("typing_dots", foreground=self.dot_color, font=("Segoe UI", 10, "bold"))
    ...
    def _animate(self):
        ...
        try:
            ...
            dots_start = self.text_widget.search(".", start_index, f"{start_index} lineend")
            ...
            self.animation_job = self.text_widget.after(self.animation_speed, self._animate)
...
def create_typing_indicator(
    ...
    return TypingIndicator(
        text_widget=text_widget, bg_color=bg_color, fg_color=fg_color, dot_color=dot_color, animation_speed=animation_speed
    )
