...
class SyntaxHighlighter:
    ...
    def _configure_syntax_tags(self):
        ...
        for token_type, color in self.COLOR_SCHEME.items():
            ...
            self.text_widget.tag_configure(tag_name, foreground=color, font=font_style)
    ...
    def highlight_code(
        self, code: str, language: Optional[str] = None, insert_position: str = tk.END
    ) -> List[Tuple[str, str]]:
        """
    ...
    def highlight_multiline_block(
        self, code: str, language: Optional[str] = None, insert_position: str = tk.END, add_background: bool = True
    ) -> str:
        """
        ...
        if add_background:
            ...
            self.text_widget.tag_configure(block_tag, background="#f5f5f5", lmargin1=10, lmargin2=10, rmargin=10)
