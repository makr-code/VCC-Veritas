...
class SessionRestoreDialog:
    ...
    def _save_settings(self):
        ...
        try:
            ...
            settings = {"auto_restore": self.auto_restore_enabled}
    ...
    def _create_ui(self):
        ...
        header_label = tk.Label(
            header_frame, text="💬 Letzte Session wiederherstellen?", font=("Segoe UI", 14, "bold"), bg="#2E86AB", fg="white"
        )
        ...
        self.tree = ttk.Treeview(
            list_frame, columns=columns, show="headings", selectmode="browse", yscrollcommand=scrollbar.set
        )
    ...
    def _load_sessions(self):
        ...
        try:
            ...
            if not sessions:
                ...
                self.tree.insert("", tk.END, values=("Keine Sessions gefunden", "", "", ""))
                return
            ...
            for session in sessions:
                ...
                item_id = self.tree.insert(
                    "", tk.END, values=(title, date_str, f"{session['message_count']} msg", session["llm_model"])
                )
