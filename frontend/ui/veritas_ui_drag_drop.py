...
ALL_SUPPORTED_FORMATS = {**SUPPORTED_DOCUMENTS, **SUPPORTED_IMAGES, **SUPPORTED_DATA, **SUPPORTED_CODE}
...
class DragDropHandler:
    ...
    def _on_drop_enter(self, event):
        ...
        try:
            ...
            self.target_widget.configure(
                relief="solid", borderwidth=2, highlightbackground="#4CAF50", highlightthickness=2  # Grün
            )
    ...
    def _on_drop(self, event):
        ...
        if errors:
            ...
            messagebox.showwarning("Ungültige Dateien", f"Folgende Dateien konnten nicht verarbeitet werden:\n\n{error_msg}")
        ...
        if valid_files:
            ...
            try:
                ...
                messagebox.showerror("Verarbeitungsfehler", f"Fehler beim Verarbeiten der Dateien:\n{str(e)}")
