...
def example_2_create_certificate():
    ...
    cert_info = cert_manager.create_certificate(
        subject_name="example.com", validity_days=365, key_size=2048, is_ca=False, organization="Example Corp", country="DE"
    )
...
def example_3_csr_signing():
    ...
    # Generate CSR
    print("Creating CSR...")
    csr = generate_csr(private_key, common_name="client.example.com", organization="Example Corp", country="DE")
    ...
    if ca_service.is_initialized():
        ...
        signed_cert = ca_service.sign_csr(csr, validity_days=365, is_ca=False)
