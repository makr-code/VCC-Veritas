...
MIGRATION_TASKS = [
    {
        ...
        "replacements": [
            ...
            (r'f"{API_BASE_URL}/health"', 'f"http://127.0.0.1:5000/health"'),  # Health ist Root-Endpoint
        ],
    },
    {
        "file": FRONTEND_DIR / "ui" / "veritas_ui_map_widget.py",
        "replacements": [
            ('backend_url: str = "http://localhost:5000"', 'backend_url: str = "http://localhost:5000/api/v3"'),
        ],
    },
    {
