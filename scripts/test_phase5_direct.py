...
async def main():
    ...
    from backend.api.veritas_phase5_integration import DEMO_CORPUS, get_hybrid_retriever, initialize_phase5_hybrid_search
    ...
    # Test queries
    test_queries = ["BGB Taschengeldparagraph Minderjährige", "Verwaltungsakt Definition VwVfG", "nachhaltig bauen Umwelt"]
