...
async def test_postgresql_connection() -> Dict[str, Any]:
    ...
    try:
        ...
        return {"status": "missing_driver", "error": "psycopg2 nicht installiert", "available": False}
    except Exception as e:
        logger.error(f"❌ PostgreSQL: Verbindung fehlgeschlagen - {e}")
        return {"status": "connection_failed", "error": str(e), "config": pg_config, "available": False}
...
async def test_neo4j_connection() -> Dict[str, Any]:
    ...
    try:
        ...
        return {"status": "missing_driver", "error": "neo4j nicht installiert", "available": False}
    except Exception as e:
        logger.error(f"❌ Neo4j: Verbindung fehlgeschlagen - {e}")
        return {"status": "connection_failed", "error": str(e), "available": False}
...
async def test_chromadb_connection() -> Dict[str, Any]:
    ...
    try:
        ...
        return {"status": "missing_driver", "error": "chromadb nicht installiert", "available": False, "optional": True}
    except Exception as e:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--action", choices=["diagnose", "create-env", "both"], default="diagnose", help="Aktion durchführen")
