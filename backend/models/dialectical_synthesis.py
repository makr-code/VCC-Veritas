...
class Contradiction:
    ...
    def __str__(self) -> str:
        return (
            f"WIDERSPRUCH ({self.severity.value}, {self.contradiction_type.value}): "
...
class DialecticalSynthesis:
    ...
    def get_summary(self) -> str:
        ...
        return (
            f"Dialektische Synthese: {len(self.theses)} Thesen, "
    ...
    def get_critical_unresolved(self) -> List[Contradiction]:
        ...
        return [c for c in self.unresolved_conflicts if c.severity == ContradictionSeverity.CRITICAL]
