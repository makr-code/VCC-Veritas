...
class ProgressCallback:
    ...
    def add_handler(self, handler: Callable[[ProgressEvent], None], event_types: Optional[List[EventType]] = None):
        """
...
def create_step_started_event(
    step_id: str, step_name: str, current_step: int, total_steps: int, metadata: Optional[Dict[str, Any]] = None
) -> ProgressEvent:
...
def create_step_failed_event(step_id: str, step_name: str, current_step: int, total_steps: int, error: str) -> ProgressEvent:
...
def create_plan_completed_event(
    total_steps: int, completed_steps: int, failed_steps: int, execution_time: float
) -> ProgressEvent:
    ...
    return ProgressEvent(
        ...
        message=message,
        execution_time=execution_time,
        data={"completed_steps": completed_steps, "failed_steps": failed_steps, "success": success},
    )
