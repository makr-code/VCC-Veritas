        ...
        try:
            ...
            if self.hybrid_enabled and opts.enable_hybrid_search:
                try:
                    ...
                    fusion_stats = (
                        self.hybrid_retriever.rrf.get_fusion_stats(cast(List[Any], hybrid_results)) if hybrid_results else {}
                    )
        ...
        if self.uds3_strategy is not None:
            ...
            if callable(semantic_search_method):
                try:
                    ...
                    result = semantic_search_method(query=query_text, top_k=opts.limit_documents)
