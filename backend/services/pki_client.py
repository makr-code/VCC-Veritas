...
class VeritasPKIClient:
    ...
    def verify_certificate(self, cert_pem: str, check_revocation: bool = True) -> Dict:
        """
        ...
        Example:
            ...
            True
        """
        data = {"certificate": cert_pem, "check_revocation": check_revocation}
    ...
    def revoke_certificate(self, serial_number: str, reason: str = "unspecified") -> Dict:
        """
        Revoke certificate.
        ...
        Example:
            ...
            'revoked'
        """
        data = {"serial_number": serial_number, "reason": reason, "requester": "veritas"}
...
def get_pki_client(base_url: Optional[str] = None, **kwargs) -> VeritasPKIClient:
    """
...
if __name__ == "__main__":
    ...
    with VeritasPKIClient() as client:
        ...
        subject = {"CN": "test.veritas.local", "O": "VCC", "OU": "VERITAS Testing"}
