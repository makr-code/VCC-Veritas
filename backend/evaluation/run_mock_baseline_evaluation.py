...
async def run_mock_baseline_evaluation():
    ...
    try:
        ...
        evaluator = RAGEvaluator(pipeline=None, ollama_client=None, strict_mode=False)  # Nutzt Mock-Response
        ...
        logger.info("=" * 80)
        logger.info("✅ MOCK BASELINE EVALUATION COMPLETE")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--mode", choices=["mock", "validate"], default="mock", help="Mock-Evaluation oder Framework-Validierung"
    )
