...
async def office_query(
    ...
    try:
        ...
        # Determine QueryMode
        mode_map = {"ask": QueryMode.ASK, "agent": QueryMode.AGENT, "edit": QueryMode.EDIT, "plan": QueryMode.PLAN}
...
@router.get("/health", summary="Office API Health Check", description="Health check für Office Add-in Integration")
