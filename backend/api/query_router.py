...
from backend.models.request import HybridSearchRequest, SimpleAskRequest, StreamingQueryRequest, UnifiedQueryRequest
...
async def unified_query(
    request_body: UnifiedQueryRequest = Body(...), query_service=Depends(get_query_service)
) -> UnifiedResponse:
    """
...
async def simple_ask(
    ask_request: SimpleAskRequest = Body(..., embed=False), query_service=Depends(get_query_service)
) -> UnifiedResponse:
    """
...
async def rag_query(
    rag_request: UnifiedQueryRequest = Body(..., embed=False), query_service=Depends(get_query_service)
) -> UnifiedResponse:
    """
...
async def hybrid_search(
    hybrid_request: HybridSearchRequest = Body(..., embed=False), query_service=Depends(get_query_service)
) -> UnifiedResponse:
    """
    ...
    unified_request = UnifiedQueryRequest(
        ...
        metadata={
            ...
            "enable_rr": hybrid_request.enable_rrf,
...
async def streaming_query(
    stream_request: StreamingQueryRequest = Body(..., embed=False), query_service=Depends(get_query_service)
) -> UnifiedResponse:
    """
