    ...
    def check_database_exists(self) -> bool:
        ...
        try:
            ...
            try:
                ...
                dsn = f"host={self.host} port={self.port} dbname=postgres user={self.user} password={self.password}"
    ...
    def get_table_stats(self) -> dict:
        ...
        try:
            ...
            for table in tables:
                ...
                # and are not user-controlled.  # nosec B608  # internal introspection
