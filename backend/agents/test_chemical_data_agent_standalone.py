...
from backend.agents.veritas_api_agent_chemical_data import (
    ChemicalDataAgent, ChemicalDataConfig,
    ChemicalDataRequest, ChemicalDataResponse,
    ChemicalIdentifierType, GHSHazardClass, RegulationDatabase,
...
class ChemicalDataTestSuite:
    ...
    async def test_name_search(self) -> bool:
        ...
        request = ChemicalDataRequest(
            query_id="test-name-benzol",
            query_text="Name-Suche für Benzol",
            search_term="benzol",
            max_results=3
        )
    ...
    async def test_safety_data_sheet(self) -> bool:
        ...
        for i in range(1, 17):
            section_attr = f"section_{i}_" + {
                ...
                8: "exposure_controls", 9: "physical_chemical", 10: "stability_reactivity",
                11: "toxicological", 12: "ecological", 13: "disposal", 14: "transport",
    ...
    async def test_integration_atmospheric(self) -> bool:
        ...
        if substance.is_hazardous():
            print(f"   Hazardous: Yes (needs dispersion modeling) ✓")
            integration_score += 1
