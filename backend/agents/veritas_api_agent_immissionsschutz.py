...
class ImmissionsschutzAgent:
    ...
    def _init_knowledge_base(self):
        ...
        self.luftqualitaet_grenzwerte = {
            "NO2": {
                "schadstof": "Stickstoffdioxid (NO2)",
        ...
        self.ta_luft_knowledge = {
            ...
            "Emissionsgrenzwerte": {
                ...
                "beispiele": ["Staub: 10 - 20 mg / m³", "NOx: 100 - 500 mg / m³", "SO2: 200 - 400 mg / m³"],
        ...
        self.keyword_mappings = {
            ...
            ImmissionsschutzCategory.TA_LUFT: ["ta luft", "technische anleitung luft", "emission", "schornstein", "ableitung"],
            ImmissionsschutzCategory.TA_LAERM: ["ta lärm", "technische anleitung lärm", "lärmgrenzwert"],
            ImmissionsschutzCategory.GRENZWERTE: ["grenzwert", "grenzwerte", "limit", "schwellenwert", "zielwert"],
        }
    ...
    def _search_luftqualitaet(self, query_text: str) -> List[Dict[str, Any]]:
        ...
        for schadstoff_key, info in self.luftqualitaet_grenzwerte.items():
            if schadstoff_key.lower() in query_lower or any(
                word in query_lower for word in info["schadstoff"].lower().split()
            ):
                results.append(
                    {
                        "schadstof": info["schadstoff"],
    ...
    def _search_laermschutz(self, query_text: str) -> List[Dict[str, Any]]:
        ...
        for gebiet_key, info in self.laermschutz_grenzwerte.items():
            if gebiet_key.lower() in query_lower or any(word in query_lower for word in info["gebietstyp"].lower().split()):
                results.append(
                    {
    ...
    def process_query(self, request: ImmissionsschutzQueryRequest) -> ImmissionsschutzQueryResponse:
        ...
        try:
            ...
            if category in [
                ...
                ImmissionsschutzCategory.UNBEKANNT,
            ]:
