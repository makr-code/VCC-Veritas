...
class BrightSkyWeatherAgent:
    ...
    def __init__(self, timeout: int = 30):
        ...
        self.session.headers.update({"User - Agent": "VERITAS - Agent/1.0"})
...
def test_brightsky_weather_agent():
    ...
    result = agent.get_current_weather(latitude=48.1351, longitude=11.5820)
    ...
    result = agent.get_weather_history(latitude=48.1351, longitude=11.5820, date=start_date, last_date=end_date)
    ...
    result = agent.get_weather_alerts(latitude=48.1351, longitude=11.5820)
