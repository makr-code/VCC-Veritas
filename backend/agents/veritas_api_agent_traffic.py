...
class PublicTransportWorker(ExternalAPIWorker):
    ...
    def _extract_transport_need(self, query: str) -> Dict[str, Any]:
        ...
        if any(word in query.lower() for word in ["bahnhof", "hauptbahnhof"]):
    ...
    async def _check_expansion_plans(self, location: Dict) -> List[Dict]:
        ...
        plans = [
            ...
            },
            {
                ...
                "expected_benefits": [
                    "Fahrzeit-Reduzierung um 15 Minuten",
                    "Alle 15 Minuten in Stoßzeiten"
                ],
...
class ParkingManagementWorker(BaseWorker):
    ...
    def _extract_parking_need(self, query: str) -> Dict[str, Any]:
        ...
        elif any(word in query.lower() for word in ["kurz", "stunde", "einkauf"]):
        ...
        alternatives.extend([
            {
                ...
                "cons": [
                    "Wetterabhängig",
                    "Zeitliche Bindung an Fahrplan",
                    "Gepäck-Transport schwieriger"
                ],
