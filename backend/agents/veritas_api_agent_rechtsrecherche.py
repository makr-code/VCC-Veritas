...
class RechtsrecherchAgent:
    ...
    def _init_knowledge_base(self):
        ...
        self.keyword_mappings = {
            ...
            Rechtsgebiet.VERWALTUNGSRECHT: ["verwaltungsrecht", "verwaltungsakt", "vwvfg", "vwgo", "verwaltungsgericht"],
            Rechtsgebiet.SOZIALRECHT: ["sozialrecht", "sgb", "sozialversicherung", "rente", "arbeitslosengeld", "sozialhilfe"],
    ...
    def _search_rechtsprechung(self, query_text: str) -> List[Dict[str, Any]]:
        ...
        for case_name, info in self.rechtsprechung_knowledge.items():
            if case_name.lower() in query_lower or any(word in query_lower for word in info["beschreibung"].lower().split()):
                results.append(
                    {
                        "case": case_name,
