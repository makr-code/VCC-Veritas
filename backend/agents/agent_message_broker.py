...
class AgentMessageBroker:
    ...
    async def start(self):
        ...
        logger.info(
            "🚀 Message-Broker gestartet " f"(Workers: {self.config.num_workers}, Batching: {self.config.enable_batching})"
        )
...
if __name__ == "__main__":
    ...
    async def test_broker():
        ...
        print("✅ Event publiziert und zugestellt")
