...
class SocialBenefitsWorker(ExternalAPIWorker):
    ...
    async def _analyze_application_processes(self, benefits: List) -> Dict[str, Any]:
        ...
        processes = {"priority_order": [], "timeline": {}, "common_documents": [], "tips": []}
        ...
        processes["priority_order"] = sorted(benefits, key=lambda x: priority_mapping.get(x["name"], 10))
        ...
        for benefit in benefits:
            ...
            if name == "Bürgergeld":
                ...
                calculations[name] = {
                    ...
                    "depends_on": ["Genaue Miethöhe", "Haushaltseinkommen", "Mietstufe der Gemeinde"],
    ...
    async def _check_benefit_combinations(self, benefits: List) -> Dict[str, Any]:
        ...
        combinations = {"allowed_combinations": [], "exclusions": [], "optimization_tips": []}
        ...
        if "Kindergeld" in benefit_names:
            combinations["allowed_combinations"].append(
                {"benefits": ["Kindergeld", "Bürgergeld"], "note": "Kindergeld wird nicht als Einkommen angerechnet"}
            )
            combinations["allowed_combinations"].append(
                {"benefits": ["Kindergeld", "Wohngeld"], "note": "Kindergeld zählt als Einkommen bei Wohngeld"}
            )

        if "Elterngeld" in benefit_names:
            combinations["allowed_combinations"].append(
                {"benefits": ["Elterngeld", "Kindergeld"], "note": "Vollständig kombinierbar"}
            )
...
class CitizenServicesWorker(BaseWorker):
    ...
    async def _identify_responsible_authority(self, request: Dict, location: Dict) -> Dict[str, Any]:
        ...
        authority_mapping = {
            "id_card": {
                ...
                "opening_hours": {"monday_friday": "08:00 - 16:00", "saturday": "09:00 - 12:00 (nur Notfälle)"},
            ...
            "passport": {
                ...
                "address": f"Hauptstraße 1, {city}",
                "opening_hours": {"monday_friday": "08:00 - 16:00", "thursday": "08:00 - 18:00"},
                "appointment_required": True,
            ...
            "drivers_license": {
                ...
                "opening_hours": {"monday_wednesday_friday": "08:00 - 12:00", "tuesday_thursday": "08:00 - 16:00"},
                "appointment_required": True,
            },
            ...
            "vehicle_registration": {
                ...
                "opening_hours": {"monday_friday": "07:30 - 15:00", "thursday": "07:30 - 17:00"},
        ...
        authority = authority_mapping.get(
            service_type,
            {
                "name": f"Bürgerbüro {city}",
                "type": "municipal",
    ...
    async def _analyze_process_steps(self, request: Dict) -> List[Dict]:
        ...
        return process_mappings.get(
            service_type,
            [{"step": 1, "title": "Zuständigkeit klären", "description": "Bei der Gemeindeverwaltung nachfragen"}],
        )
    ...
    async def _determine_required_documents(self, request: Dict) -> Dict[str, Any]:
        ...
        document_requirements = {
            "id_card": {
                ...
                "optional": ["Meldebescheinigung (falls Adresse nicht aktuell)"],
            ...
            "vehicle_registration": {
                ...
                "for_new_cars": ["EG - Übereinstimmungsbescheinigung (CoC)", "Rechnung des Händlers"],
                "for_used_cars": ["Fahrzeugbrief mit Verkäufer - Unterschrift", "Kaufvertrag"],
            },
            "business_registration": {
                "mandatory": [
                    "Personalausweis",
    ...
    async def _calculate_costs_and_fees(self, request: Dict, location: Dict) -> Dict[str, Any]:
        ...
        fee_structure = {
            ...
            "vehicle_registration": {
                ...
                "license_plate": {"standard": 10.20, "seasonal": 15.00, "custom_plate": 12.80, "electric_e_plate": 10.20},
                "additional_costs": {
...
class HealthInsuranceWorker(ExternalAPIWorker):
    ...
    def _extract_health_inquiry(self, query: str) -> Dict[str, Any]:
        ...
        inquiry = {"inquiry_type": "general", "specific_need": None, "budget_concern": False, "service_priority": "standard"}
            ...
            gkv_options = [
                {
                    ...
                    "digital_services": {"app_rating": 4.3, "online_services": "umfangreich", "video_consultations": True},
                },
                {
            ...
            pkv_options = [
                {
                    ...
                    "estimated_monthly_cost": {"age_30": 450, "age_40": 520, "age_50": 680},
                    "benefits": [
                        "Chefarztbehandlung",
                        "Einzelzimmer",
                    ...
                    "pros": ["Keine Wartezeiten bei Fachärzten", "Bessere Leistungen", "Beitragsrückerstattung möglich"],
                    "cons": [
    ...
    async def _compare_benefits(self, insurances: List, inquiry: Dict) -> Dict[str, Any]:
        ...
        comparison = {"basic_benefits": {}, "additional_benefits": {}, "cost_comparison": {}, "recommendation_matrix": {}}
        ...
        if specific_need == "dental":
            ...
            for insurance in insurances:
                if insurance["type"] == "GKV":
                    ...
                    dental_coverage = "Bis zu 100% je nach Tari"
    ...
    async def _analyze_switching_options(self, situation: Dict) -> Dict[str, Any]:
        ...
        options = {"possible_switches": [], "restrictions": [], "optimal_timing": {}, "process_steps": []}
    ...
    async def _perform_cost_analysis(self, insurances: List, situation: Dict) -> Dict[str, Any]:
        ...
        analysis = {"monthly_costs": {}, "annual_comparison": {}, "lifetime_projection": {}, "cost_factors": {}}
        ...
        for insurance in insurances:
            if insurance["type"] == "GKV":
                monthly_cost = min(example_income * insurance["total_rate"] / 100, 797.72)  # Höchstbeitrag 2025
