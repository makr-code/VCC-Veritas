...
class AgentOrchestrator:
    ...
    def preprocess_query(self, query_data: Dict[str, Any], rag_context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        logger.info(f"🔍 Query Preprocessing abgeschlossen: {complexity.value}/{domain.value} - {len(preprocessing_result['required_agents'])} Agents")
    ...
    def _analyze_query_complexity(self, query_text: str) -> QueryComplexity:
        ...
        standard_indicators = [
            ...
            'zuständig', 'berechtigt', 'antrag', 'frist', 'voraussetzung'
        ]
