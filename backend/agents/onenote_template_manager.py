"""
OneNote Template Manager - CRUD operations for OneNote templates

Manages note templates for meeting notes, project notes, research, and checklists.
"""
...
class OneNoteTemplateManager:
    """
    Manager for OneNote templates
    ...
    def __init__(self, templates_dir: Optional[Path] = None):
        """
        Initialize OneNote Template Manager
        
        Args:
            templates_dir: Directory containing template YAML files
        """
        if templates_dir is None:
            self.templates_dir = Path(__file__).parent / "onenote_templates"
        else:
        ...
        logger.info(f"OneNoteTemplateManager initialized with dir: {self.templates_dir}")
    ...
    def list_templates(self, category: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        Args:
            category: Optional category filter (meeting_notes, project_notes, research_notes, etc.)
...
# Singleton instance
_onenote_template_manager = None


@lru_cache(maxsize=1)
def get_onenote_template_manager() -> OneNoteTemplateManager:
    """
    Get singleton instance of OneNoteTemplateManager
    
    Returns:
        OneNoteTemplateManager instance
    """
    global _onenote_template_manager
    if _onenote_template_manager is None:
        _onenote_template_manager = OneNoteTemplateManager()
    return _onenote_template_manager
