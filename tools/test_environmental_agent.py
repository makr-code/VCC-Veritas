    ...
    steps = [
        {
            ...
            "step_config": json.dumps(
                {"query": "air quality Munich", "domain": "environmental", "top_k": 10, "use_uds3": True}
            ),
        },
        {
            "step_id": f"{plan_id}_step_002",
            ...
            "agent_type": "EnvironmentalAgent",
            "status": "pending",
            "step_config": json.dumps({"regulation_type": "environmental", "jurisdiction": "Germany", "topic": "air_quality"}),
        ...
        },
        {
            ...
            "status": "pending",
            "step_config": json.dumps(
                {"metrics": ["PM2.5", "PM10", "NO2", "O3"], "location": "Munich", "timeframe": "30_days"}
            ),
            "depends_on": [f"{plan_id}_step_001"],
        },
        {
            ...
            "agent_type": "EnvironmentalAgent",
            "status": "pending",
            "step_config": json.dumps({"project_type": "urban_development", "location": "Munich", "scope": "air_quality"}),
    ...
    for step in steps:
        ...
        try:
            result = agent.execute_step(
                {"step_type": step["step_type"], "step_config": step_config}, {"plan_id": plan["plan_id"]}
            )
