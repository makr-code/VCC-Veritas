...
def _configure_forest_styles(style, theme_name):
    ...
    try:
        ...
        if theme_name == "dark":
            colors = {"bg": "#313131", "fg": "#ffffff", "accent": "#217346", "select_bg": "#217346", "select_fg": "#ffffff"}
        else:  # light
            colors = {"bg": "#ffffff", "fg": "#000000", "accent": "#217346", "select_bg": "#217346", "select_fg": "#ffffff"}
...
def _apply_veritas_customizations(style, theme_name):
    ...
    try:
        ...
        # Statusbar-Labels
        style.configure("Status.TLabel", font=("Segoe UI", 8), anchor="w")
...
def apply_theme_to_widget(widget, theme_colors=None):
    ...
    try:
        ...
        if isinstance(widget, (tk.Tk, tk.Toplevel, tk.Frame)):
            ...
            widget.configure(bg=theme_colors.get("bg", "#f0f0f0"), fg=theme_colors.get("fg", "#2d2d2d"))
        elif isinstance(widget, tk.Button):
            widget.configure(bg=theme_colors.get("button_bg", "#e8e8e8"), fg=theme_colors.get("button_fg", "#2d2d2d"))
        elif isinstance(widget, tk.Entry):
            widget.configure(bg=theme_colors.get("entry_bg", "#ffffff"), fg=theme_colors.get("entry_fg", "#2d2d2d"))
        elif isinstance(widget, tk.Text):
            widget.configure(bg=theme_colors.get("text_bg", "#ffffff"), fg=theme_colors.get("text_fg", "#2d2d2d"))
