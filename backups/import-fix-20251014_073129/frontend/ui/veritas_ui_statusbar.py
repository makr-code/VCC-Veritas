...
class ChatStatusBar(tk.Frame):
    ...
    def _create_widgets(self):
        ...
        self.status_label = tk.Label(self, text="Bereit", bd=0, relief="flat", anchor=tk.W, padx=10, pady=1)
        ...
        self.version_label = tk.Label(
            right_frame, text=f"v{self.app_version}", bd=0, relief="flat", anchor=tk.E, padx=10, pady=2
        )
