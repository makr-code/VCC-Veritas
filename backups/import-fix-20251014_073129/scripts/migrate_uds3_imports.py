...
IMPORT_PATTERNS: List[Tuple[str, str, str]] = [
    ...
    (r"^(\s*)import uds3_(\w+)(.*)$", r"\1import uds3.uds3_\2\3", "import uds3_X → import uds3.uds3_X"),
    ...
    for line_num, line in enumerate(lines, 1):
        for pattern, replacement, description in IMPORT_PATTERNS:
            ...
            if match:
                ...
                if new_line != line:
                    changes.append({"line_num": line_num, "old_line": line, "new_line": new_line, "pattern_desc": description})
                break  # Only apply first matching pattern

    return {"changes": changes, "total_lines": len(lines)}
