...
async def final_test():
    ...
    test_questions = [
        {
            ...
            "sources": ["[1] LBO BW Gesetzestext § 58", "[2] Bauordnungsamt Leitfaden 2024"],
        ...
        },
        {
            ...
            "sources": ["[1] Berliner Luftgütemessnetz", "[2] Umweltbundesamt Bericht 2024"],
    ...
    for i, test in enumerate(test_questions, 1):
        ...
        # Send to Ollama
        request = OllamaRequest(model="llama3.2:latest", prompt=full_prompt, temperature=0.5, max_tokens=2000)
        ...
        if is_json:
            ...
            results.append(
                {"question": test["query"], "json_generated": False, "formatted": False, "citations": 0, "unique_citations": 0}
            )
