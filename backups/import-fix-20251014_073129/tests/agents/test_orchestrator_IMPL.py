...
class TestAgentOrchestrator:
    ...
    def mock_uds3(self):
        ...
        uds3 = MagicMock()
        uds3.search = AsyncMock(return_value=[{"id": "doc1", "score": 0.95, "text": "Test document"}])
        return uds3
    ...
    def agent_instance(self, mock_coordinator, mock_pipeline_manager, mock_uds3):
        ...
        agent = AgentOrchestrator(
            mock_coordinator=mock_coordinator, mock_pipeline_manager=mock_pipeline_manager, mock_uds3=mock_uds3
        )
        return agent
...
class TestAgentOrchestratorMigration:
    ...
    def test_can_be_registered_in_registry(self):
        ...
        registry = {}
        registry["agentorchestrator"] = {"class": agent.__class__, "instance": agent, "domain": "orchestration"}
