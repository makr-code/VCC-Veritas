...
# Import agent
try:
    from backend.agents.veritas_api_agent_pipeline_manager import AgentPipelineManager, AgentQueryItem
...
class TestAgentPipelineManagerMigration:
    ...
    def test_can_be_registered_in_registry(self):
        ...
        registry = {}
        registry["agentpipelinemanager"] = {"class": agent.__class__, "instance": agent, "domain": "pipeline"}
