...
# Import agent
try:
    from backend.agents.veritas_api_agent_registry import AgentCapability, AgentRegistry
...
class TestAgentRegistryMigration:
    ...
    def test_can_be_registered_in_registry(self):
        ...
        registry = {}
        registry["agentregistry"] = {"class": agent.__class__, "instance": agent, "domain": "registry"}
