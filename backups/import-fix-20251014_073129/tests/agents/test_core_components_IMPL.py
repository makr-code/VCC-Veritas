...
# Import agent
try:
    from backend.agents.veritas_api_agent_core_components import AgentMessageType, CoreComponentsAgent
...
class TestCoreComponentsAgentMigration:
    ...
    def test_can_be_registered_in_registry(self):
        ...
        registry = {}
        registry["corecomponentsagent"] = {"class": agent.__class__, "instance": agent, "domain": "core"}
