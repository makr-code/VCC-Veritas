...
class MockOfficeExportService:
    ...
    def export_to_word(self, chat_messages, filename=None, title="VERITAS Chat", include_metadata=True, include_sources=True):
        """Mock Word export"""
...
def test_word_export_with_custom_filename(export_service, sample_messages):
    ...
    # Act
    output_path = export_service.export_to_word(sample_messages, filename="custom_report.docx")
...
def test_word_export_without_docx_extension(export_service, sample_messages):
    ...
    # Act
    output_path = export_service.export_to_word(sample_messages, filename="report_without_extension")
...
def test_word_export_with_metadata(export_service, sample_messages):
    ...
    # Act
    output_path = export_service.export_to_word(sample_messages, include_metadata=True)
...
def test_word_export_without_metadata(export_service, sample_messages):
    ...
    # Act
    output_path = export_service.export_to_word(sample_messages, include_metadata=False)
...
def test_word_export_with_sources(export_service, sample_messages):
    ...
    # Act
    output_path = export_service.export_to_word(sample_messages, include_sources=True)
...
def test_word_export_custom_title(export_service, sample_messages):
    ...
    # Act
    output_path = export_service.export_to_word(sample_messages, title="Weekly Chat Report")
...
def test_excel_export_with_custom_filename(export_service, sample_messages):
    ...
    # Act
    output_path = export_service.export_to_excel(sample_messages, filename="data_export.xlsx")
...
def test_excel_export_with_feedback_stats(export_service, sample_messages, sample_feedback_stats):
    ...
    # Act
    output_path = export_service.export_to_excel(sample_messages, feedback_stats=sample_feedback_stats)
...
def test_excel_export_without_feedback_stats(export_service, sample_messages):
    ...
    # Act
    output_path = export_service.export_to_excel(sample_messages, feedback_stats=None)
...
def test_export_filename_sanitization(export_service, sample_messages):
    ...
    # Act
    output_path = export_service.export_to_word(sample_messages, filename="report_2025.docx")  # Valid filename
