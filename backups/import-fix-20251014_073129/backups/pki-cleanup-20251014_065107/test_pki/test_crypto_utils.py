...
from pki.exceptions import DecryptionError, EncryptionError, InvalidCSRError, KeyGenerationError, SignatureVerificationError
...
class TestCSRGeneration:
    ...
    def test_generate_csr_invalid_key(self):
        ...
        with pytest.raises(InvalidCSRError):
            generate_csr(private_key_pem="not a key", common_name="test.local")
