...
from .config import CERT_HASH_ALGORITHM, CERT_KEY_SIZE, MOCK_FINGERPRINT_LENGTH
from .exceptions import DecryptionError, EncryptionError, InvalidCSRError, KeyGenerationError, SignatureVerificationError
...
def calculate_fingerprint(cert_pem: str, algorithm: str = CERT_HASH_ALGORITHM) -> str:
    """
