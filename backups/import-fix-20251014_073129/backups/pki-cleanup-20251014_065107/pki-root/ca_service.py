...
from .crypto_utils import calculate_fingerprint, generate_key_pair
from .exceptions import CANotInitializedError, CertificateRevokedError, InvalidCSRError
...
class CAService:
    ...
    def __init__(self, ca_name: str = CA_NAME, auto_initialize: bool = False):
        """
    ...
    def initialize_ca(self, validity_years: int = CA_VALIDITY_YEARS) -> bool:
        """
...
-----END CERTIFICATE-----"""
    ...
    def sign_csr(self, csr_pem: str, validity_days: int = CERT_VALIDITY_DAYS, cert_type: str = "server") -> Dict[str, Any]:
        """
        ...
        try:
            subject_line = [line for line in csr_pem.split("\n") if line.startswith("Subject:")][0]
...
-----END X509 CRL-----"""
    ...
    def revoke_certificate(self, serial_number: str, reason: str = "unspecified") -> bool:
        ...
        # Füge zur CRL hinzu
        revocation_entry = {"serial_number": serial_number, "revocation_date": datetime.now(timezone.utc), "reason": reason}
        self._revoked_serials.append(revocation_entry)

        return True

    def verify_chain(self, cert_pem: str, include_crl_check: bool = True) -> bool:
        """
        ...
        try:
            serial_line = [line for line in cert_pem.split("\n") if "Serial Number:" in line][0]
    ...
    def get_signed_certificates(self, include_revoked: bool = False) -> List[Dict[str, Any]]:
        """
