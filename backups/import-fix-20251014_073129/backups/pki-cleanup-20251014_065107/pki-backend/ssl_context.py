...
def create_mtls_client_context(client_cert: str, client_key: str, ca_cert: str, check_hostname: bool = True) -> ssl.SSLContext:
    """
...
def get_certificate_info_from_context(ssl_socket: ssl.SSLSocket) -> dict:
    ...
    try:
        ...
        if not peer_cert:
            return {"error": "No peer certificate available", "verified": False}
