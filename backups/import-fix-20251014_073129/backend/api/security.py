...
ROLE_PERMISSIONS: Dict[UserRole, Set[Permission]] = {
    UserRole.ADMIN: {
        ...
        Permission.PLAN_CREATE, Permission.PLAN_READ, Permission.PLAN_UPDATE, 
        Permission.PLAN_DELETE, Permission.PLAN_EXECUTE,
        ...
        Permission.QUALITY_REVIEW, Permission.QUALITY_OVERRIDE,
        Permission.ORCHESTRATION_PAUSE, Permission.ORCHESTRATION_RESUME,
        Permission.ORCHESTRATION_CANCEL, Permission.ORCHESTRATION_INTERVENE,
    },
    UserRole.USER: {
        Permission.PLAN_CREATE, Permission.PLAN_READ, Permission.PLAN_UPDATE, 
    ...
    UserRole.SERVICE: {
        Permission.PLAN_CREATE, Permission.PLAN_READ, Permission.PLAN_EXECUTE,
        Permission.AGENT_READ,
...
class RateLimiter:
    ...
    def get_remaining(self, identifier: str) -> int:
        ...
        recent_requests = sum(
            1 for timestamp in self.request_counts[identifier]
            if now - timestamp < self.window_seconds
        )
