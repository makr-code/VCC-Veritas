...
from framework.streaming_manager import (
    StreamingManager,
    StreamEvent,
    EventType,
...
async def test_streaming_manager():
    ...
    await manager.stream_event(
        StreamEvent(
            ...
            plan_id="plan_stream_001",
            data={"query": "Test query"}
        )
    )
    
    print(f"✓ Event streamed")
