        ...
        for tax in taxes:
            ...
            if tax_type == "Grundsteuer B":
                rates[tax_type] = {
                    ...
                    "comparison_average": {"bavaria": 520, "germany": 459},
                }
                ...
                rates[tax_type] = {
                    ...
                    "municipality": municipality,
                    "comparison_average": {"bavaria": 345, "germany": 356},
                }
        ...
        if inquiry.get("tax_type") == "property_tax":
            ...
            analysis["business_tax"] = {
                ...
                "municipal_variation": {
                    ...
                    "range": "200-900%",
                    "economic_factors": ["Standortattraktivität", "Infrastruktur-Bedarf", "Kommunale Finanzsituation"],
                },
            }
            ...
            remedies.append(
                {
                    ...
                    "requirements": ["Berechtigtes Interesse darlegen", "Antrag bei zuständiger Behörde"],
                    "expected_outcome": [
        ...
        remedies.append(
            {
                ...
                "when_recommended": ["Komplexe Sachverhalte", "Hohe Steuerbeträge", "Wiederholte Probleme"],
            }
        )
...
class FundingOpportunitiesWorker(ExternalAPIWorker):
    ...
    def __init__(self):
        ...
        super().__init__(
            WorkerType.FUNDING_OPPORTUNITIES, "https://api.finanzverwaltung.de/", cache_ttl=3600
        )  # 1 Stunde Cache
        self.funding_apis = {
            ...
            programs.extend(
                [
                    ...
                    },
                    {
                        ...
                        "max_amount": 60000,
                        "requirements": ["Mindestinvestition 2.000€", "Fachbetrieb durchführung", "Antrag vor Baubeginnen"],
                        "eligible_measures": ["Wärmepumpen", "Solarthermie", "Biomasse-Heizungen", "Dämmung Gebäudehülle"],
            ...
            programs.append(
                {
                    ...
                    "additional_grants": {"heating_bonus": 1000, "efficiency_bonus": 1000},
                    "requirements": [
                        "Wohnsitz in Bayern",
        ...
        programs.append(
            {
                ...
                "max_amount": 5000,
                "requirements": ["Gebäude in Altstadtbereich", "Verbesserung des Straßenbildes", "Vorlage Farbkonzept"],
                "eligible_measures": ["Fassadenrenovierung", "Denkmalgerechte Fenster", "Historische Haustüren"],
            }
        )
    ...
    async def _analyze_combination_options(self, programs: List) -> Dict[str, Any]:
        ...
        combinations = {"possible_combinations": [], "restrictions": [], "optimization_strategies": []}
            ...
            evaluation["complexity_ranking"].append(
                {
                    ...
                    "estimated_effort_hours": {"low": 5, "medium": 15, "high": 40}.get(complexity, 10),
                }
            )
    ...
    def _assess_success_probability(self, request: Dict, programs: List) -> Dict[str, Any]:
        ...
        assessment = {"overall_probability": "medium", "program_assessments": [], "success_factors": [], "risk_factors": []}
...
class BusinessTaxOptimizationWorker(BaseWorker):
        ...
        municipalities = [
            {
                ...
                "annual_cost_example": {"profit_50k": 8575, "profit_100k": 17150, "profit_500k": 85750},
            },
            {
                "name": "Augsburg",
                "hebesatz": 420,
                ...
                "annual_cost_example": {"profit_50k": 7350, "profit_100k": 14700, "profit_500k": 73500},
            },
            {
                "name": "Garching",
                "hebesatz": 240,
                ...
                "population": 18000,
                "economic_strength": "sehr hoch",
                "annual_cost_example": {"profit_50k": 4200, "profit_100k": 8400, "profit_500k": 42000},
    ...
    def _perform_cost_benefit_analysis(self, tax_comparison: Dict, location_factors: Dict) -> Dict[str, Any]:
        ...
        analysis = {"total_cost_calculation": {}, "recommendation": {}, "sensitivity_analysis": {}}
