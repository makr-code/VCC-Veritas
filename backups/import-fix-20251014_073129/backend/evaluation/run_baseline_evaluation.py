...
async def initialize_pipeline() -> IntelligentMultiAgentPipeline:
    ...
    try:
        ...
        raise RuntimeError("Pipeline konnte nicht initialisiert werden") from e
...
async def run_baseline_evaluation():
    ...
    try:
        ...
        evaluator = RAGEvaluator(
            pipeline=pipeline, ollama_client=pipeline.ollama_client, strict_mode=False  # Nicht zu streng für Baseline
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", choices=["baseline", "comparative"], default="baseline", help="Evaluation-Modus")
