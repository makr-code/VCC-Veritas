...
class TextToSpeechManager:
    ...
    def speak_text(self, text: str, interrupt_current: bool = True) -> bool:
        ...
        try:
            ...
            speech_thread = threading.Thread(target=self._speak_in_thread, args=(cleaned_text,), daemon=True)
            speech_thread.start()
    ...
    def set_voice_properties(
        self, rate: Optional[int] = None, volume: Optional[float] = None, voice_id: Optional[str] = None
    ) -> bool:
        """
