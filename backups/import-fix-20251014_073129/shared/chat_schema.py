...
class ChatSession(BaseModel):
    ...
    def add_message(self, role: str, content: str, attachments: List[str] = None, metadata: Dict[str, Any] = None):
        """Fügt neue Nachricht zur Session hinzu"""
        message = ChatMessage(role=role, content=content, attachments=attachments or [], metadata=metadata or {})
...
if __name__ == "__main__":
    ...
    session.add_message(
        "assistant", "Das Bundes-Immissionsschutzgesetz (BImSchG)...", metadata={"confidence": 0.887, "sources": 8}
    )
