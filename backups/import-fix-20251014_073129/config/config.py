...
class CovinaConfig:
    ...
    def _load_core_config(self):
        ...
        self.backend_worker_config = {
            ...
            "fallback_mode": os.getenv(
                "COVINA_BACKEND_FALLBACK_MODE", "partial_storage"
            ),  # 'partial_storage', 'fail', 'continue'
        }
        ...
        self.image_processing_config = {
            ...
            "processing_mode": os.getenv(
                "COVINA_IMAGE_PROCESSING_MODE", "auto"
            ),  # 'auto', 'ocr_only', 'description_only', 'full'
            ...
            "memory_optimization": os.getenv(
                "COVINA_IMAGE_MEMORY_OPTIMIZATION", "balanced"
            ),  # 'fast', 'balanced', 'memory_saving'
            # DSGVO-Integration
        ...
        self.archive_processing_config = {
            ...
            "extraction_mode": os.getenv(
                "COVINA_ARCHIVE_EXTRACTION_MODE", "subfolder"
            ),  # 'in_place', 'subfolder', 'temp_dir', 'custom_path'
            ...
            "supported_formats": os.getenv(
                "COVINA_SUPPORTED_ARCHIVE_FORMATS", "zip,rar,7z,tar,tar.gz,tar.bz2,tar.xz,gz,bz2"
            ).split(","),
            ...
            "file_scanner_priority": os.getenv(
                "COVINA_ARCHIVE_SCANNER_PRIORITY", "normal"
            ...
            "metadata_detail_level": os.getenv(
                "COVINA_ARCHIVE_METADATA_DETAIL", "standard"
        ...
        self.followup_config = {
            "max_pending_backend": int(
                os.getenv("COVINA_FOLLOWUP_MAX_PENDING_BACKEND", os.getenv("FOLLOWUP_MAX_PENDING_BACKEND", "250"))
            ),
            "max_pending_llm": int(os.getenv("COVINA_FOLLOWUP_MAX_PENDING_LLM", os.getenv("FOLLOWUP_MAX_PENDING_LLM", "60"))),
            "digest_interval_s": int(
                os.getenv("COVINA_FOLLOWUP_DIGEST_INTERVAL_S", os.getenv("FOLLOWUP_DIGEST_INTERVAL_S", "60"))
            ),
    ...
    def get_server_config(self) -> Dict[str, Any]:
        ...
        return {"host": self.app_host, "port": self.app_port, "api_base_url": self.api_base_url}
