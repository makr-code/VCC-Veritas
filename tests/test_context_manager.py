...
class TestConversationContextManager:
    ...
    def test_relevance_based_context(self, manager, sample_session):
        ...
        result = manager.build_conversation_context(
            chat_session=sample_session, current_query="Welche Lärmgrenzwerte gibt es?", strategy="relevance", max_messages=3
        )
    ...
    def test_context_formatting(self, manager, sample_session):
        ...
        result = manager.build_conversation_context(
            chat_session=sample_session, current_query="Test", strategy="sliding_window", max_messages=2
        )
    ...
    def test_token_limit_enforcement(self, manager):
        ...
        result = manager.build_conversation_context(
            chat_session=long_session, current_query="Test", strategy="all", max_messages=100
        )
    ...
    def test_empty_session(self, manager):
        ...
        result = manager.build_conversation_context(
            chat_session=empty_session, current_query="Test", strategy="sliding_window"
        )
    ...
    def test_single_message_session(self, manager):
        ...
        result = manager.build_conversation_context(
            chat_session=single_session, current_query="Wie geht's?", strategy="sliding_window"
        )
    ...
    def test_long_message_truncation(self, manager):
        ...
        result = manager.build_conversation_context(chat_session=session, current_query="Test", strategy="all")
