...
def sample_documents():
    ...
    return [
        {"doc_id": "doc_0", "content": "§110 BGB Taschengeldparagraph...", "metadata": {"source": "legal", "type": "bgb"}},
        {"doc_id": "doc_1", "content": "§433 BGB Kaufvertrag...", "metadata": {"source": "legal", "type": "bgb"}},
    ]
...
def sample_context():
    ...
    return {"user_id": "test_user", "session_id": "test_session_123", "query": "test query", "parameters": {}}
...
def mock_uds3_manager():
    ...
    mock.query_across_databases = AsyncMock(
        return_value={
...
def mock_ollama_client():
    ...
    mock.chat = AsyncMock(return_value={"message": {"content": "This is a mock LLM response."}})

    mock.embed = AsyncMock(return_value={"embedding": [0.1] * 384})  # Mock 384-dim embedding
...
def mock_tool_registry():
    ...
    registry.get_tool = Mock(return_value={"name": "test_tool", "description": "A test tool", "parameters": {}})
