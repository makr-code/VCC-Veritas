...
# Import agent
try:
    from backend.agents.veritas_api_agent_social import Agent
...
class TestAgent:
    ...
    @pytest.mark.asyncio
    async def test_social_query(self, agent_instance):
        """Test social-specific query processing."""
        # TODO: Add social domain test
        pytest.skip("Test not implemented yet")
