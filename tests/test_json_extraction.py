...
```"""
    ...
    def test_extract_next_steps(self):
        ...
        json_data = {
            "next_steps": [{"action": "Action 1", "type": "link"}, {"action": "Action 2", "type": "info"}],
            "other": "data",
        }
    ...
    def test_extract_related_topics(self):
        ...
        json_data = {"related_topics": ["Topic A", "Topic B", "Topic C"], "other": "data"}
...
"""
        ...
        try:
            result = template.format(query="Test-Query", context="Test-Context")
