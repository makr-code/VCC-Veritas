...
from backend.services.reranker_service import RerankingResult, ScoringMode
...
class TestQueryServiceHybridMode:
    ...
    @pytest.mark.asyncio
    async def test_hybrid_search_success(self, mock_uds3, mock_pipeline, sample_query_request, sample_hybrid_result):
    ...
    @pytest.mark.asyncio
    async def test_hybrid_search_calls_rag_service(self, mock_uds3, mock_pipeline, sample_query_request, sample_hybrid_result):
    ...
    async def test_reranking_applied_when_enabled(
        self, mock_uds3, mock_pipeline, sample_query_request, sample_hybrid_result, sample_reranking_results
    ):
        """Test that reranking is applied when enabled"""

        with patch("backend.services.query_service.RAGService") as MockRAGService, patch(
            "backend.services.query_service.RerankerService"
    ...
    async def test_reranking_disabled_when_flag_false(
        self, mock_uds3, mock_pipeline, sample_query_request, sample_hybrid_result
    ):
    ...
    @pytest.mark.asyncio
    async def test_unified_response_format(self, mock_uds3, mock_pipeline, sample_query_request, sample_hybrid_result):
    ...
    @pytest.mark.asyncio
    async def test_source_metadata_fields(self, mock_uds3, mock_pipeline, sample_query_request, sample_hybrid_result):
    ...
    @pytest.mark.asyncio
    async def test_fallback_when_rag_service_unavailable(self, mock_pipeline, sample_query_request):
    ...
    @pytest.mark.asyncio
    async def test_fallback_when_hybrid_search_fails(self, mock_uds3, mock_pipeline, sample_query_request):
    ...
    @pytest.mark.asyncio
    async def test_reranking_fallback_on_error(self, mock_uds3, mock_pipeline, sample_query_request, sample_hybrid_result):
    ...
    @pytest.mark.asyncio
    async def test_empty_search_results(self, mock_uds3, mock_pipeline, sample_query_request):
    ...
    @pytest.mark.asyncio
    async def test_max_results_limit(self, mock_uds3, mock_pipeline, sample_query_request, sample_search_results):
    ...
    @pytest.mark.asyncio
    async def test_confidence_score_calculation(self, mock_uds3, mock_pipeline, sample_query_request, sample_hybrid_result):
