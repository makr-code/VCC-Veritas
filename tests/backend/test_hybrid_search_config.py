...
class TestSearchWeights:
    ...
    def test_to_dict_serialization(self):
        ...
        assert data == {"vector": 0.6, "graph": 0.2, "relational": 0.2}
...
class TestSearchFilters:
    ...
    def test_custom_filters(self):
        ...
        filters = SearchFilters(max_results=10, min_relevance=0.7, document_types=["pdf", "docx"])
...
class TestReRankingConfig:
    ...
    def test_custom_reranking_config(self):
        ...
        config = ReRankingConfig(enabled=False, model_name="llama3.2:3b", temperature=0.2, batch_size=10)
...
class TestLoadConfigFromEnv:
    ...
    @patch.dict(os.environ, {"HYBRID_MAX_RESULTS": "30", "HYBRID_MIN_RELEVANCE": "0.7", "HYBRID_RRF_K": "100"}, clear=True)
