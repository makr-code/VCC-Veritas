...
def test_get_feedback_stats_last_7_days(mock_feedback_api):
    ...
    # Arrange
    expected_stats = {"total_feedback": 42, "positive_count": 35, "positive_ratio": 83.3, "period": "7_days"}
...
def test_get_feedback_stats_last_30_days(mock_feedback_api):
    ...
    # Arrange
    expected_stats = {"total_feedback": 95, "positive_count": 78, "positive_ratio": 82.1, "period": "30_days"}
    mock_feedback_api.get_stats.return_value = expected_stats
...
def test_list_feedback_filter_by_message_id(mock_feedback_api):
    ...
    # Arrange
    expected_feedback = [{"id": "fb_001", "message_id": "msg_123", "rating": 1}]
...
def test_list_feedback_filter_by_rating(mock_feedback_api):
    ...
    # Arrange
    positive_feedback = [{"id": "fb_001", "rating": 1}, {"id": "fb_003", "rating": 1}]
