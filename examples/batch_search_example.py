...
from backend.services.rag_service import RAGService, SearchFilters, SearchMethod, SearchWeights
...
async def main():
    ...
    results = await rag.batch_search(queries=queries, search_method=SearchMethod.HYBRID, filters=SearchFilters(max_results=5))
